export default (formValues) => {
    ...
    const {is_active, first_name, last_name, email, password, password_new, phone, address_1, address_2, country, city, state, zip, membership_plan, file, file_name} = formValues;
