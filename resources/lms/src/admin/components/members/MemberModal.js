...
export const MemberModal = (props) => {
    ...
    const delConfig = { memberId: member ? member.id : null };
    const modalOptions = {
        modalTitle: getModalTitle(isCreate, isEdit, isDelete, 'members.modal.add.title',
            'members.modal.edit.title', 'members.modal.delete.title'),
