export default (formValues) => {
    ...
    const {is_active, first_name, last_name, email, password, password_new, phone, role_id, address_1, address_2, country_id, city, state, zip, file, file_name} = formValues;
